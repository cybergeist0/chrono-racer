...
public class ManualPrometeoCarController : MonoBehaviour
{
    ...
    */
        ...
        */
        ...
        else
        {
            ...
            else
            {
                ...
                if ((!Input.GetKey(KeyCode.K) && !Input.GetKey(KeyCode.I)) && !Input.GetKey(KeyCode.P) && !deceleratingCar)
                {
                    InvokeRepeating("DecelerateCar", 0f, 0.1f);
                    deceleratingCar = true;
                }
                if (!Input.GetKey(KeyCode.J) && !Input.GetKey(KeyCode.L) && steeringAxis != 0f)
                {
                    ResetSteeringAngle();
                }
            }
    ...
    {
        // Only apply penalty if this is the player car and the other is the AI car
